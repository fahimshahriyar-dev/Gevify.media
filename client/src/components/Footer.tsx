            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2.5 text-[13.5px] text-zinc-400">
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                  <Link
                    to="/about"
                    className="hover:text-[#5ACFFE] transition-colors duration-200"
                  >
                    About
                  </Link>
          ...
          <div className="flex flex-col items-start md:items-end space-y-6">
            ...
            <div className="space-y-2 min-w-0">
              ...
              <a
                ...
                className="flex items-center gap-2 text-zinc-400 hover:text-[#5ACFFE] transition-colors duration-200 text-sm break-all"
              >
                <svg
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#0086F0] hover:border-[#0086F0] transition-all duration-300 text-zinc-400 hover:text-white"
              >
