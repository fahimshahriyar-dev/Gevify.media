          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-white/[0.06] border border-white/10 text-white placeholder-zinc-500 focus:outline-none focus:border-[#0086F0]/80 focus:ring-1 focus:ring-[#0086F0]/50 transition-all duration-200 text-[15px]"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-white/[0.06] border border-white/10 text-white placeholder-zinc-500 focus:outline-none focus:border-[#0086F0]/80 focus:ring-1 focus:ring-[#0086F0]/50 transition-all duration-200 text-[15px] uppercase tracking-wider"
              />
            </div>
          </div>
